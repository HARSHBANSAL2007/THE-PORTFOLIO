...
export default function ContactModal({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-center justify-center bg-void/85 p-4 backdrop-blur-2xl">
      <div
        ref={dialogRef}
        tabIndex={-1}
        role="dialog"
        ...
        className="relative w-full max-w-xl rounded-3xl border border-line bg-void-card p-6 shadow-[0_20px_50px_rgba(0,0,0,0.95)] ring-1 ring-inset ring-white/10 sm:p-8"
      >
        ...
        <button
          ...
          onClick={onClose}
          aria-label="Close"
          className="absolute right-6 top-6 grid h-8 w-8 place-items-center rounded-full border border-line bg-void text-steel transition-colors hover:text-white"
        >
        ...
        <h3 id="contact-modal-title" className="text-2xl font-black uppercase text-white">
          Send a message
        </h3>
        ...
        <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          >
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <div className="text-[9px] text-steel uppercase">GMAIL ADDRESS</div>
          ...
          >
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <div className="text-[9px] text-steel uppercase">PHONE DIRECT</div>
          ...
          >
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <div className="text-[9px] text-steel uppercase">GITHUB PROFILE</div>
          ...
          >
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <div className="text-[9px] text-steel uppercase">LINKEDIN NETWORK</div>
          ...
          >
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <div className="text-[9px] text-steel uppercase">DISCORD COMMUNITY SERVER & USER</div>
        ...
        <form onSubmit={handleSubmit} className="mt-6 border-t border-line/50 pt-5 space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              <label className="block font-mono text-[9px] uppercase tracking-wider text-steel mb-1">
                Your Name / Team
              </label>
              <input
                required
          ...
          <p className="text-center font-mono text-[9px] uppercase tracking-[0.18em] text-steel">
